...
public class StandardSong implements Serializable{


	private static final long serialVersionUID = 5630373522020505491L;
	...
	public void setPlay_seconds(Long play_seconds) {

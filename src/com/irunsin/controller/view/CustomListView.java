package com.irunsin.controller.view;
...
public class CustomListView extends ListView implements OnScrollListener {
	...
	//是否显示加载更多  是否允许下拉刷新
	private boolean wnLoadMore = true; // 初始为true 只有搜索中需要初始为false然后在改为ture
	/**  可以下拉刷新？   */
	...
	public boolean isWnLoadMore() {
		return wnLoadMore;
	}

	public void setWnLoadMore(boolean wnLoadMore) {
		this.wnLoadMore = wnLoadMore;
		if(mCanLoadMore && getFooterViewsCount() == 0 && wnLoadMore){
			addFooterView();
		}
	}
...
//				}
	...
	public void onRefreshComplete() {
		...
		mLastUpdatedTextView.setTextColor(R.color.content_grey);
		changeHeaderViewByState();
	}
	...
	/**
	 * 当已经没有更多可以加载时  去掉加载更多显示
	 */
	public void ridLoadMore(){
		mCanLoadMore = false;
		mEndRootView.setVisibility(View.GONE);
		mEndRootView.setOnClickListener(new View.OnClickListener() {
			@Override

...
public abstract class Parser 
{
	 ...
	 * @throws IOException 
	 */
	public Node addDeviceParse(URL locationURL) throws ParserException, IOException,SocketTimeoutException{
		String host = locationURL.getHost();
		int port = locationURL.getPort();
		// Thanks for Hao Hu 
		if (port == -1)
	...
	public Node sendHttpAddDevice(URL locationURL) throws ParserException{
		String host = locationURL.getHost();
		int port = locationURL.getPort();
		// Thanks for Hao Hu 
		if (port == -1)

...
public class HTTPRequest extends HTTPPacket
{
	...
	public HTTPResponse post(String host, int port, boolean isKeepAlive)
	{
		...
		InputStream in = null;
//		Log.i("httpsend", getHeader() + HTTP.CRLF + getContentString());
//		Log.i("httpsend", HTTP.CRLF);
 		try {
 			if (postSocket == null){
 				// Thanks for Hao Hu 
				...
				//添加读写超时时间
				postSocket.setSoTimeout(60*1000);
 			}
...
//			Log.i("httpsend", "结果如下:"+ httpRes.getContentString());

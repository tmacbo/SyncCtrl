...
//			Log.i("Service", "<name>" +actionList.getAction(i).getName()+"</name>");
//			Log.i("Service", "<argumentList>");
//			for(int j=0;j<actionList.getAction(i).getArgumentList().size();j++){				
//				Log.i("Service", "<argument>");
//				Log.i("Service", "<name>"+actionList.getAction(i).getArgumentList().getArgument(j).getName() +"</name>");
//				Log.i("Service", "<direction>"+actionList.getAction(i).getArgumentList().getArgument(j).getDirection() +"</direction>");
//				Log.i("Service", "<relatedStateVariable>"+actionList.getAction(i).getArgumentList().getArgument(j).getRelatedStateVariableName() +"</relatedStateVariable>");				
//				Log.i("Service", "<argument>");					
//			}
//			Log.i("Service", "<argumentList>");
//			Log.i("Service", "</action>");
